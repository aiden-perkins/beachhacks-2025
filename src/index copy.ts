...
import { CardUIBuilder, TableUIBuilder, OAuthUIBuilder, AgentInfo, requestAuthenticationTool } from '@dainprotocol/utils';
...
const listPullRequestsConfig: ToolConfig = {
    ...
    handler: async ({ owner, repo, state }, agentInfo, { app }) => {
        ...
        if (!tokens) {
            return requestAuthenticationTool({provider: "github", logo: ""}, { app, agentInfo });
        }
...
const listRepoContentsConfig: ToolConfig = {
    ...
    description: "Lists files and directories in a GitHub repository",
    input: z.object({
        owner: z.string(),
        repo: z.string(),
...
const getIssueCommentsConfig: ToolConfig = {
    ...
    description: "Retrieves all comments on a GitHub issue",
    input: z.object({
        owner: z.string(),
        repo: z.string(),
        issue_number: z.number()
...
const getProjectStructureConfig: ToolConfig = {
    ...
    description: "Returns the complete file structure of a GitHub repository",
    input: z.object({
        owner: z.string(),
        repo: z.string(),
...
const analyzeRepoHealthConfig: ToolConfig = {
    ...
    description: "Analyzes repository health including issues, dependencies, tests, and code usage",
    input: z.object({
        owner: z.string(),
        repo: z.string(),
...
const closePullRequestConfig: ToolConfig = {
    ...
    description: "Closes an open pull request in a GitHub repository",
    input: z.object({
        owner: z.string(),
        repo: z.string(),
        pull_number: z.number()
